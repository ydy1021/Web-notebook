...
import com.duc.memorandum.controller.FileController;  
...
public class AliyunOSSUpload implements Runnable {  
    ...
    //空间名称
    private static String bucketName="dongxiaoyan";
	 //账号ID
    private static String accessKeyID="LTAIUZrjxkJFddft";
	 //密码
    private static String accessKeySecret="c4YMIYCvaPuulGpfuORf7FQAKJMdmI";
     ...
     * @return 
     */  
    public static String claimUploadId(String bucketName, String key) {  
